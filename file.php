...
<nav aria-label="breadcrumb ">
  <ol class="breadcrumb">
	<li class="breadcrumb-item"><a class="text-success" href="index.php?page=file">Files</a></li>
  </ol>
</nav>
...
<?php include 'accreditorsfile.php' ?>
...
<div id="menu-file-clones" style="display: none;">
	<a href="javascript:void(0)" class="custom-menus-list file-option view"><span><i class="fa fa-eye"></i> </span>View File</a>
