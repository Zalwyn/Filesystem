		...
		<div class="row">
			<div class="card col-lg-12">
				...
				while($id > 0){
					...
					echo '<script>
						$("#paths").prepend("<a class=\"text-primary\" href=\"index.php?page=files&fid='.$path['id'].'\">'.$path['name'].'</a> / ")
					</script>';
					$id = $path['parent_id'];

				}
				echo '<script>
						$("#paths").prepend("<a class=\"text-primary\" href=\"index.php?page=files\"><i class=\"fa fa-desktop\"></i></a> / ")
					</script>';
				?>
...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="row">
			<button class="btn btn-warning " id="new_folder"><i class="fa fa-folder-plus"></i> New Folder</button>
			<button class="btn btn-danger ml-4" id="new_file"><i class="fa fa-file-upload"></i> Upload File</button>
		</div>
...
<div id="menu-folder-clone" style="display: none;">
	<a href="javascript:void(0)" class="custom-menu-list file-option edit"><i class="fa fa-edit"></i> Edit</a>
	<a href="javascript:void(0)" class="custom-menu-list file-option delete"><i class="fa fa-trash"></i> Delete</a>
</div>
<div id="menu-file-clone" style="display: none;">
	<a href="javascript:void(0)" class="custom-menu-list file-option edit"><span><i class="fa fa-edit"></i> </span>Edit</a>
	<a href="javascript:void(0)" class="custom-menu-list file-option view"><span><i class="fa fa-eye"></i> </span>View</a>
	<a href="javascript:void(0)" class="custom-menu-list file-option share"><span><i class="fa fa-share"></i> </span>Share</a>
...
<script>
	...
	$("div.file.custom-menu .share").click(function(e){
		e.preventDefault()
				uni_modal('Rename File','manage_files.php?fid=<?php echo $folder_parent ?>&id='+$(this).attr('data-id') )
