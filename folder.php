...
a.custom-menu-list:hover,.folder-item:hover,.folder-item.active {
    background: #80808024;
}
table th,td{
		...
		<div class="row">
			<div class="card col-lg-12">
				...
				while($id > 0){
					...
					echo '<script>
						$("#paths").prepend("<a class=\"text-primary\" href=\"index.php?page=folder&fid='.$path['id'].'\">'.$path['name'].'</a> / ")
					</script>';
					$id = $path['parent_id'];

				}
				echo '<script>
						$("#paths").prepend("<a class=\"text-primary\" href=\"index.php?page=folder\"><i class=\"fa fa-folder\"></i></a> / ")
					</script>';
				?>
...
<hr>
		<div class="row" align="right">
			...
			<div class="col-md-4 input-group offset-4">
  				...
  				<input type="text" placeholder="Search......" class="form-control" id="search" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
	...
	?>
		<div class="row" style="margin-left: 10px">
			...
			?>
				<div class="card col-md-3 mt-2 ml-2 mr-2 mb-2 folder-item" data-id="<?php echo $row['id'] ?>">
					<div class="card-body">
	<large><span><center><div class="to_folders"> <br><i class="fa fa-user-check"></i> <?php echo ucwords($row['uname']) ?></div><hr><i class="fa fa-folder"></i></span><b class="to_folder">					<?php echo $row['name'] ?></b></large></center>
					</div>
				</div>
			<?php endwhile; ?>
...
<script>
	...
	$('.folder-item').dblclick(function(){
		location.href = 'index.php?page=folder&fid='+$(this).attr('data-id')
	})
